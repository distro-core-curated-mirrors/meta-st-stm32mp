...
SRC_URI:append:stm32mp2common = " file://STM32MP21_CA35.svd;subdir=git/data/STMicro"
SRC_URI:append:stm32mp2common = " file://STM32MP21_CM33.svd;subdir=git/data/STMicro"
SRC_URI:append:stm32mp2common = " file://STM32MP23_CA35.svd;subdir=git/data/STMicro"
SRC_URI:append:stm32mp2common = " file://STM32MP23_CM33.svd;subdir=git/data/STMicro"
...
SRC_URI:append:class-nativesdk = " file://STM32MP21_CA35.svd;subdir=git/data/STMicro"
SRC_URI:append:class-nativesdk = " file://STM32MP21_CM33.svd;subdir=git/data/STMicro"
